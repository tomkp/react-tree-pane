...
var _libTreePane = require('../lib/TreePane');

var _libTreePane2 = _interopRequireDefault(_libTreePane);
...
var Example = _react2['default'].createClass({
    ...
    render: function render() {
        return _react2['default'].createElement(_libTreePane2['default'], { model: model, cellRenderer: _react2['default'].createElement(CustomCellRenderer, null) });
    }
});

_react2['default'].render(_react2['default'].createElement(Example, null), document.body);

},{"../lib/TreePane":2,"react":158}],2:[function(require,module,exports){
'use strict';
