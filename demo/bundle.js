...
},{"../lib/TreePane":2,"react":176}],2:[function(require,module,exports){
"use strict";
...
var TreePane = _reactAddons2["default"].createClass({
...
var Node = _reactAddons2["default"].createClass({
    displayName: "Node",
    ...
    render: function render() {
        ...
        if (children) {
            if (this.state.expanded) {
                childNodes = children.map(function (node, index) {
                    return _reactAddons2["default"].createElement(Node, { key: index, model: node, renderer: renderer });
                });
            }
            classes.push("toggle");
        ...
        if (renderer) {
            cellRenderer = _reactAddons2["default"].addons.cloneWithProps(renderer, {
